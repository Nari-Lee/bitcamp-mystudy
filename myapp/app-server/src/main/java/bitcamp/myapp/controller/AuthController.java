...
/**
 * packageName    : bitcamp.myapp.servlet.auth fileName       : LoginServlet author         :
 * narilee date           : 24. 8. 28. description    : 사용자의 로그인을 처리하는 서블릿 클래스입니다. 이 서블릿은 사용자의
 * 이메일과 비밀번호를 검증하고, 로그인 성공시 세션에 사용자 정보를 저장합니다.
 * =========================================================== DATE              AUTHOR
 * NOTE
 * -----------------------------------------------------------
 ...
 * 24. 9. 19.        narilee       Servlet을 Controller로 전환후 통합
 */
